...
export default function StaffLibraryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 🔥 แก้ไข: ใช้ String() เพื่อแปลง user.id ให้เป็น string
      if (user?.id) {
  ...
  return (
    <StaffShell activePath="/staff/library">
        ...
        <div className="min-h-[calc(100vh-8.5rem)] rounded-2xl border border-blue-100 bg-white/95 p-4 shadow-[0_18px_50px_rgba(15,23,42,0.08)] sm:p-6">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">
                จัดเก็บและจัดการแม่แบบเกียรติบัตร ใบเซอร์ และเอกสารต่างๆ
              </p>
            </div>
            <button
              type="button"
          ...
          {loading ? (
            ...
            <div className="mt-6 rounded-2xl border border-blue-100 bg-white py-16 text-center text-slate-400 shadow-[0_14px_34px_rgba(15,23,42,0.07)]">
              ...
              <p className="mt-4 text-lg font-medium text-slate-500">ยังไม่มีแม่แบบ</p>
