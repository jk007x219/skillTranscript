...
export default function TeacherSettingsPage() {
  ...
  if (loading) {
    return (
      <TeacherShell activePath="/teacher/settings">
  ...
  const displayName = `${profile?.firstName || ""} ${profile?.lastName || ""}`.trim() || "อาจารย์";
          ...
          <form onSubmit={handleSubmit} className="mt-6 grid gap-5 xl:grid-cols-[340px_1fr]">
            ...
            <aside className="rounded-2xl border border-blue-100 bg-gradient-to-b from-blue-50 to-white p-5">
              ...
              <div className="mt-6 space-y-3">
                ...
                <InfoLine icon={GraduationCap} label="โปรแกรม/สาขา" value={profile?.program || "-"} />
              </div>
            </aside>
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-2xl border border-blue-100 bg-[#F8FCFF] p-5">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  ...
                  <ReadOnlyField label="โปรแกรม/สาขา" value={profile?.program || "-"} />
                </div>
              </div>
